...
**Convert any text into a custom voice using edge-tts and RVC (Retrieval-based Voice Conversion).** <br>
*Built with Streamlit for a sleek, interactive, and modern web interface.*

[![Python](https://img.shields.io/badge/Python-3.10+-3776AB?style=for-the-badge&logo=python&logoColor=white)](https://python.org)
[![Streamlit](https://img.shields.io/badge/Streamlit-1.30+-FF4B4B?style=for-the-badge&logo=streamlit&logoColor=white)](https://streamlit.io)
[![License](https://img.shields.io/badge/License-MIT-green?style=for-the-badge)](#)

<img src="./menu_ss.png" alt="RVC TTS Studio Interface" width="800" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
...
> [!WARNING]  
> **You must install the correct PyTorch build _before_ installing the other dependencies.**
